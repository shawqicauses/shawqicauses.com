...
// DONE REVIEWING: GITHUB COMMIT 1️⃣9️⃣
...
// THEME
const SunIcon = function SunIcon(props: ComponentPropsWithoutRef<"svg">) {
  return (
    <svg
      viewBox="0 0 24 24"
      strokeWidth={1.5}
...
const MoonIcon = function MoonIcon(props: ComponentPropsWithoutRef<"svg">) {
  return (
    <svg viewBox="0 0 24 24" aria-hidden="true" {...props}>
      <path
        strokeWidth={1.5}
